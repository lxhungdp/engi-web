        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {product.applications.map((app) => (
              <div key={app} className={cn(tc.cardSubtle, "p-4 text-sm font-medium text-foreground")}>
                {app}
              </div>
            ))}
          </div>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {product.workflow.map((step) => (
              <div key={step.step} className={cn(tc.card, "p-5")}>
                ...
                <h3 className="font-heading mt-2 font-semibold text-foreground">{step.title}</h3>
