    ...
    <div className="pt-28 pb-20">
      <div className="mx-auto max-w-2xl px-6 lg:px-8">
        ...
        {submitted ? (
          <div
            className={cn(
              "mt-12 rounded-xl border border-accent/20 bg-accent/5 p-8 text-center",
              tc.card,
            )}
          >
          ...
          <form
            ...
            className={cn("mt-12 space-y-5 rounded-xl border p-8", tc.card)}
          >
            {[
            ...
            <label className="flex items-start gap-2 text-sm text-foreground-secondary">
              ...
              <span>
                I agree to the{" "}
                <Link href={companyRoutes.privacy} className={tc.linkAccent}>
                  Privacy Policy
                </Link>{" "}
                *
              </span>
