    ...
    <footer className="border-t border-border bg-footer">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <p className={cn("max-w-md text-sm leading-relaxed", tc.body)}>
            This is a demo product website created by{" "}
            <span className="text-accent">EngiWeb</span> to showcase a
            product-launch website style.
          </p>
          <Link
            href="/"
        ...
        <div className="mt-10 border-t border-border pt-6 text-center">
          <p className="text-xs text-foreground-muted">
            &copy; {new Date().getFullYear()} AeroVolt X1 Demo. Fictional product
