      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <p className={cn("max-w-lg text-sm leading-relaxed", tc.body)}>
            This is a demo construction engineering website created by{" "}
            <span className="text-accent">EngiWeb</span> to showcase a
            professional corporate website style for infrastructure and civil
        ...
        <div className="mt-10 border-t border-border pt-6 text-center">
          <p className="text-xs text-foreground-muted">
            &copy; {new Date().getFullYear()} TerraBuild Engineering Demo.
